...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='response',
            name='file_a',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='a_responses', to='filerater.file'),
        ),
        migrations.AddField(
            model_name='response',
            name='file_b',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='b_responses', to='filerater.file'),
        ),
        migrations.AddField(
            model_name='response',
            name='user',
        ...
        migrations.AddConstraint(
            model_name='sequence',
            constraint=models.UniqueConstraint(fields=('seed',), name='unique_sequence_seed'),
        ),
        migrations.AddField(
            model_name='sequenceitem',
            name='file_a',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='a_items', to='filerater.file'),
        ),
        migrations.AddField(
            model_name='sequenceitem',
            name='file_b',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='b_items', to='filerater.file'),
        ),
        migrations.AddField(
            model_name='sequenceitem',
            name='sequence',
        ...
        migrations.AddConstraint(
            model_name='response',
            constraint=models.UniqueConstraint(fields=('user', 'file_a', 'file_b'), name='unique_files_per_response'),
        ),
        migrations.AddConstraint(
            model_name='response',
            constraint=models.CheckConstraint(check=models.Q(('file_a_id__lt', models.F('file_b_id'))), name='response_a_lt_b'),
        ),
        migrations.AddConstraint(
            model_name='sequenceitem',
